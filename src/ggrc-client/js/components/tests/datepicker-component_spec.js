...
describe('datepicker component', () => {
  ...
  beforeEach(() => {
    ...
    viewModel.date = null;
    viewModel.inputDate = null;
    viewModel.minDate = null;
    viewModel.maxDate = null;
    viewModel.setMinDate = null;
    viewModel.setMaxDate = null;
    someValue = null;
    expectedResult = null;
  });
  ...
  describe('viewModel', () => {
    describe('date setter', () => {
      ...
      it('should return date for ISO date argument',
        () => {
          ...
          expect(viewModel.date).toBe(expectedResult);
        });

      it('should return null for not ISO date argument',
        () => {
          someValue = '2019-03-03';
          viewModel.date = '03/03/2019';

          expect(viewModel.date).toBeNull();
        });
    });
    ...
    describe('inputDate setter', () => {
      ...
      if format of argument is FTM`, () => {
        ...
        viewModel.inputDate = someValue;

        expect(viewModel.inputDate).toBe(expectedResult);
      });
      ...
      if format of argument is not FTM`, () => {
        ...
        expect(viewModel.inputDate).toBeNull();
      });
    ...
    describe('onSelect() method', () => {
      ...
      it('sets false to isShown attribute', () => {
        ...
        expect(viewModel.isShown).toBe(expectedResult);
      });
    });
    ...
    describe('onFocus() method', () => {
      it('sets false to showTop attribute', () => {
        ...
        viewModel.showTop = true;
        viewModel.onFocus();
        expectedResult = false;

        expect(viewModel.showTop).toBe(expectedResult);
      });
  ...
  describe('events', () => {
    ...
    describe('inserted() method', () => {
      ...
      it('sets new datepicker to picker of viewModel', () => {
        method();
        expect(viewModel.picker[0]).toBe(element[0]);
      });

      it('should set minDate corrected value from setMinDate',
        () => {
          someValue = '2019-03-03';
          viewModel.setMinDate = someValue;
          expectedResult = '2019-03-04';
      ...
      it('should set maxDate corrected value from setMaxDate',
        () => {
          someValue = '2019-03-03';
          viewModel.setMaxDate = someValue;
          expectedResult = '2019-03-02';
